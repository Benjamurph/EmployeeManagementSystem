        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllocatedLeave = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employees_SystemCodeDetails_InactiveReasonId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employees_SystemCodeDetails_TerminationReasonId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiredId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobBoards_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobBoards_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobBoards_Designations_DesignationId",
                        column: x => x.DesignationId,
                        principalTable: "Designations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobBoards_SystemCodeDetails_ExpiredId",
                        column: x => x.ExpiredId,
                        principalTable: "SystemCodeDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_InactiveReasonId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobBoards_CityId",
                table: "JobBoards",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_JobBoards_DepartmentId",
                table: "JobBoards",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_JobBoards_DesignationId",
                table: "JobBoards",
                column: "DesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_JobBoards_ExpiredId",
                table: "JobBoards",
                column: "ExpiredId");
